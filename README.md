...
- 明场/相差圆细胞使用双极性多尺度 DoG/LoG 式 blob 检测，同时识别“亮中心—暗环”和“暗中心—亮环”；再通过 Hessian 各向同性、连续径向相差环和背景恢复校验及非极大值抑制，排除圆孔边缘、细长结构和微小纹理，并确保每个圆细胞只计数一次。
- 提供“自动（按倍镜推荐）/ 圆细胞·相差圆点 / 铺展贴壁细胞”选择。自动模式在 4× 推荐圆点模式，在 10×/20× 推荐铺展模式，也可手动覆盖。
...
- **AI 识别对象**：悬浮、未贴壁的亮中心或暗中心相差圆点选择“圆细胞 / 相差圆点”；纺锤形、多边形或相互接触的贴壁细胞选择“铺展贴壁细胞”。
- **ROI**：培养孔黑边不是细胞，建议用圆形 ROI 只圈住孔内有效培养区域，再生成网格分析。
